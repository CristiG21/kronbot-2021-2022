...
@Autonomous(name = "Autonomie Timer Blue Cube Only")
public class AutonomieTimerBlueCubeOnly extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        DriveAcc(-1, -1, -1, -1, speed, 0.58, acc, 0.02);
        ...
        DriveAcc(-1, 1, -1, 1, speed, 0.61, acc, 0.02);
        ...
        DriveAcc(-1, -1, -1, -1, speed, 3, acc, 0.02);
    }
